...
public class SetupApp {
	...
	public boolean initSystemTray() {
		...
		popup.insert("Chess.com",2);
		popup.insert("Chess.com/live",3);
		popup.insert("Chess.com/clubs/home",4);
		popup.insertSeparator(5);
		popup.insert("Chess-results.com",6);
		popup.insert("ENF Tournaments (Chile)",7);
